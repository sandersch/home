...
| `etc/ssh/vault-ingest-authorized-keys/vault-ingest-ryze` | `/etc/ssh/vault-ingest-authorized-keys/vault-ingest-ryze` | `root:root` `600` | generated public half only; created by the attended ryze enrollment and never contains the private key |
