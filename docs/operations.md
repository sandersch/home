...
| Item | When to do it |
|---|---|
| **k3s pin and update controls** | Repo-authored container image pinning and Renovate configuration are complete. Implement the remaining k3s installer pin in [version-management.md](./version-management.md) before the next rebuild or host upgrade. |
